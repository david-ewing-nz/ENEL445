...
\end{minipage}\hfill
\begin{minipage}[t]{0.46\linewidth}
\textbf{BFGS — quasi-Newton} \quad $p_0 = -B_0^{-1}\nabla f(X_0)$,\; $B_0=I$
...
\[
  \nabla f(X_0) = \begin{bmatrix}6\\10\end{bmatrix}
  \;\Rightarrow\;
  p_0 = -I\begin{bmatrix}6\\10\end{bmatrix} = \begin{bmatrix}-6\\-10\end{bmatrix}
\]

\textbf{Line search:} $\hat{X}_1 = \begin{bmatrix}3-6\alpha\\1-10\alpha\end{bmatrix}$
...
\[
  ...
  \;\Rightarrow\; \alpha_0=\frac{136}{1072}\approx 0.1269
\]
...
\textbf{BFGS vectors} (for $B_1$ update):
\[
  s_0 = X_1-X_0 = \begin{bmatrix}-0.7614\\-1.269\end{bmatrix}
\]
\[
  y_0 = \nabla f(X_1)-\nabla f(X_0)
      = \begin{bmatrix}4.478\\-2.69\end{bmatrix}-\begin{bmatrix}6\\10\end{bmatrix}
      = \begin{bmatrix}-1.522\\-12.689\end{bmatrix}
\]

$s_0,y_0$ feed the rank-2 update: $B_1 = B_0 - \dfrac{B_0 s_0 s_0^\top B_0}{s_0^\top B_0 s_0} + \dfrac{y_0 y_0^\top}{y_0^\top s_0}$

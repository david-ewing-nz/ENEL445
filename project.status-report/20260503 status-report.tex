...
Instead of computing the true posterior, VI finds the ``best'' approximation $q(\bm{\theta})$ from a tractable family 
by maximising the Evidence Lower Bound (ELBO). 
This transforms intractable integration into tractable optimisation---I think this is a natural fit for an optimisation course project. \vspace{2em} 
...
\noindent\textbf{Wainwright, M.J.\ and Jordan, M.I.} (2008).
\textit{Graphical Models, Exponential Families, and Variational Inference}.
Foundations and Trends\textregistered{} in Machine Learning, \textbf{1}(1--2), pp.\ 1--305.
DOI: \href{https://doi.org/10.1561/2200000001}{10.1561/2200000001}
\begin{itemize}
  \item Section 3.4 --- exponential families, natural parameterisation, and covariance structure.
\end{itemize}

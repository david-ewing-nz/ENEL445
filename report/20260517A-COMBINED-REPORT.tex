...
focus falls on CS1 (Bayesian linear regression),
CS4 (hierarchical linear), and CS5 (hierarchical logistic).
...
complete code listings. All five individual case study reports are available online at:
\begin{center}
...
This appendix contains all promptssubmitted to the AI tool during preparation of this report that could be reported.  Copilot had crashed on occasion and those prompts are unrecoverable. 
\medskip
...
editing, tactical execution of compiling xelatex, spell-checking, running code,
code debugging, and knowledge lookup as permitted by the ENEL445 course outline. It was used to add the prompts themselves to this appediix. 

\medskip
\noindent The following prompts were submitted to the AI tool during preparation
of this report.

\verbatiminput{prompts-combined.md}

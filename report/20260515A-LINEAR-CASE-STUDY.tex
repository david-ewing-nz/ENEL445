...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\linewidth]{linear_likelihood_posterior.png}
  \caption{Likelihood and CAVI posterior for the linear predictor.
    The red dashed line is the true regression mean $y=2.0+1.5x$ (the likelihood mean);
    the tomato band is the 95\% noise interval $\pm 2\sigma_e = \pm 1.0$, showing where
    individual observations are expected to fall.

...
[Results to be filled from \texttt{python/linear\_run.ipynb}.
Key figures: \texttt{figs/linear\_*.png}.
Key tables: \texttt{results/tables/linear\_diagnostics.csv}.]
...
[Results to be filled from \texttt{python/quadratic\_run.ipynb}.
Key figures: \texttt{figs/quadratic\_*.png}.
Key tables: \texttt{results/tables/quadratic\_diagnostics.csv}.]

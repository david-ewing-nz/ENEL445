...
The statistical setting used throughout the report is Bayesian regression. The same Bayesian framework is used for both the linear and quadratic test cases; the quadratic case is handled by expanding the design matrix to include the nonlinear feature $x^2$, while the model remains linear in the coefficient vector.

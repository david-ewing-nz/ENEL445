...
Bayesian quadratic regression extends the linear baseline by augmenting the design matrix
with a squared feature $x^2$; with conjugate Gaussian--Gamma priors the model remains
analytically tractable, making it the natural test of whether optimisation behaviour
observed in the linear case is robust to a nonlinear feature expansion.
...
Throughout all gradient-based methods, the variational covariance $\bm{\Sigma}_\beta$ must
